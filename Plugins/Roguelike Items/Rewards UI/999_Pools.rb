...
GameData::RewardPool.register({
  :id        => :base_pools,
  :common    => [
    :POTION, :POKEBALL, :ORANBERRY, :ANTIDOTE, :PARALYZEHEAL, :AWAKENING, 
    :BURNHEAL, :ICEHEAL, :PECHABERRY, :CHERIBERRY, :CHESTOBERRY, :RAWSTBERRY, 
    :ASPEARBERRY, :REPEL, :DATACORE_COMMON, :RELIC_MUSCLE, :RELIC_LENS, :RELIC_EXTENDER
  ],
  :rare      => [
    :SUPERPOTION, :GREATBALL, :REVIVE, :SITRUSBERRY, :LUMBERRY, :FOCUSBAND,
    :LANSATBERRY, :STARFBERRY, :LEPPABERRY, :QUICKBALL, :TIMERBALL, :REPEATBALL,
    :XATTACK, :XDEFENSE, :XSPATK, :XSPDEF, :XSPEED, :DIREHIT, :DATACORE_RARE, :RELIC_MUSCLE, :RELIC_LENS, :RELIC_EXTENDER,
  ],
  :epic      => [
    ...
    :CUSTAPBERRY, :MAXREVIVE, :QUICKCLAW, :KINGSROCK, :DATACORE_EPIC, :RELIC_MUSCLE, :RELIC_LENS, :RELIC_EXTENDER, :HOLLOWED_SOUL
  ],
  :legendary => [
    :FULLRESTORE, :RARECANDY, :ABILITYPATCH, :PPMAX, :LIFEORB, :ABILITYSHIELD,
    :CHOICEBAND, :CHOICESPECS, :CHOICESCARF, :ASSAULTVEST, :FOCUSSASH,
    :CLEARAMULET, :MIRRORHERB, :BOOSTERENERGY, :MASTERBALL, :MAXELIXIR, 
    :DATACORE_LEGENDARY, :RELIC_MUSCLE, :RELIC_LENS, :RELIC_EXTENDER, :HOLLOWED_SOUL
  ]
})
