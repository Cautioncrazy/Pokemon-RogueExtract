...
def pbBountyBoard
  ...
  loop do
    ...
    if choice == 0
      ...
      # Slayer Bounty
      if $PokemonGlobal.quests.active_quests.any? { |q| q.id == "1" }
        pbMessage(_INTL("You have already accepted the Slayer bounty."))
      elsif $PokemonGlobal.quests.completed_quests.any? { |q| q.id == "1" }
      ...
      # Gatherer Bounty
      if $PokemonGlobal.quests.active_quests.any? { |q| q.id == "2" }
        pbMessage(_INTL("You have already accepted the Gatherer bounty."))
      elsif $PokemonGlobal.quests.completed_quests.any? { |q| q.id == "2" }
      ...
      # Survivor Bounty
      if $PokemonGlobal.quests.active_quests.any? { |q| q.id == "3" }
        pbMessage(_INTL("You have already accepted the Survivor bounty."))
      elsif $PokemonGlobal.quests.completed_quests.any? { |q| q.id == "3" }
